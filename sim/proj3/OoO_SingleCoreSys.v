//========================================================================
// OoO Single-Core System
//========================================================================

`ifndef OoO_SINGLE_CORE_SYS_V
`define OoO_SINGLE_CORE_SYS_V

`include "vc/mem-msgs.v"
`include "vc/trace.v"

`include "proj3/ProcOoO.v"
`include "cache/DCache4B.v"
`include "cache/ICache4B.v"

module proj3_OoO_SingleCoreSys
(
  input  logic          clk,
  input  logic          reset,
